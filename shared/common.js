...
(function(){
  ...
  window.GZ_COLLECT_ENDPOINT = 'https://strain-accessibility-conversations-ing.trycloudflare.com/api/collect';
...
//   Cache suffix must be monotonically increasing to avoid browser reusing old version.
  var s1=document.createElement('script');s1.src='/monetag-manager.js?v=20260628812a';s1.defer=true;document.head.appendChild(s1);
  ...
  var s4=document.createElement('script');s4.src='/adsense-auto.js?v=20260628812b';s4.defer=true;document.head.appendChild(s4);
