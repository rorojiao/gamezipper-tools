...
(function(){
  ...
  window.GZ_COLLECT_ENDPOINT = 'https://collectables-prisoners-architectural-influenced.trycloudflare.com/api/collect';
  ...
  var s5=document.createElement('script');s5.src='/gz-analytics.js?v=20260615ZR3';s5.defer=true;s5.fetchPriority='low';s5.crossOrigin='anonymous';document.head.appendChild(s5);
