...
(function(){
  ...
  window.GZ_COLLECT_ENDPOINT = 'https://applications-queensland-services-administrative.trycloudflare.com/api/collect';
...
//   Cache suffix must be monotonically increasing to avoid browser reusing old version.
  ...
  // v5.24 (2026-07-09, t_0576328a): load monetag-manager.v524.js — guard
  //   showInPagePush() with isHubPage (11012002 only fills on hub pages;
  //   sub-page was 100% wasted call). Add inpage_push_fill event. Align
  ...
  // v5.27 (2026-07-15, t_ed9d6e6f): bump to monetag-manager.v527.js
  //   11012002 hub-only fix (BI 7d: tools 11012002 fill=0/no_fill=27 vs gz.com 42.1%).
  //   Cache buster v527hubonly11012002 forces fresh fetch.
  var s1=document.createElement('script');s1.src='/monetag-manager.v527.js?v=v527hubonly11012002';s1.defer=true;document.head.appendChild(s1);
  ...
  // work (just no ad overlay). Footer self-dismisses via sessionStorage.
  ...
  var s5=document.createElement("script");s5.src="/gz-analytics.js?v=20260715tunnelsailpermanent";s5.defer=true;s5.fetchPriority='low';s5.crossOrigin='anonymous';document.head.appendChild(s5);
...
const GZ = (function(){
  ...
  function renderHeader(activeCat) {
    ...
    header.innerHTML = `
      ...
      <a href="https://gamezipper.com" target="_blank" style="background:#ffd93d;color:#1a1a2e;padding:6px 14px;border-radius:20px;font-weight:700;font-size:0.85rem;text-decoration:none;margin-left:8px;white-space:nowrap;">🎮 ${t('playGames')}</a>
  ...
  function tryInjectAfterRelated() {
    ...
    try {
      ...
      var placement = related ? 'after_related' : 'body_fallback';
